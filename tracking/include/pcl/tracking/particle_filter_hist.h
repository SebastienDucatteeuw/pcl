#ifndef PCL_TRACKING_PARTICLE_FILTER_HIST_H_
#define PCL_TRACKING_PARTICLE_FILTER_HIST_H_
...
namespace pcl
{
  namespace tracking
  {
    ...
    class ParticleFilterTrackerHist: public Tracker<PointInT, StateT>
    {
      protected:
...
#endif //PCL_TRACKING_PARTICLE_FILTER_HIST_H_
